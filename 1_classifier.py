...
print(clf.predict([[160, 0], [80, 0], [144, 1]]))
...
features2 = [[30, 0, 1, 2, 0], [28, 0, 0, 2, 0], [68, 0, 1, 1, 0], [92, 1, 1, 1, 1], [67, 1, 1, 2, 0], [24, 0, 1, 0, 0], [94, 0, 0, 1, 1]]
lables2 = [0, 0, 0, 1, 1, 0, 1]
# Train the classifier with our dataw
clf2 = tree.DecisionTreeClassifier().fit(features2, lables2)
# Label the features we're passing in
clf2 = clf2.predict([[22,0,1,2,0], [82,1,1,1,1], [95,1,0,1,1], [32,0,0,0,0], [50, 1, 0, 0, 0], [50, 0, 0, 0, 0]])
# Print results
print("Results are : ", clf2)
