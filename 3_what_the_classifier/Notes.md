...
![Picture from yt channel statisticsfun](Screenshots/maxresdefault.jpg?raw=true "Optional Title")
...
![State 1 of the graph](Screenshots/firstgraph.png?raw=true "Optional Title")
...
![State 2 of the graph](Screenshots/secondgraph.png?raw=true "Optional Title")
...
![State 3 of the graph](Screenshots/thirdgraph.png?raw=true "Optional Title")
...
![State 4 of the graph](Screenshots/fourthgraph.png?raw=true "Optional Title")
